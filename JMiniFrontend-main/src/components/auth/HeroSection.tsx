...
const HeroSection = ({
  ...
  const textContent = (
    <div className={`${onlyText ? "text-foreground" : "text-white"} ${className}`}>
      <h2 className="text-3xl font-bold mb-2 brand">DreamsDoc</h2>
      <p className="text-lg opacity-90">Share Dreams && Connect with everyone</p>
    </div>
  );
  ...
  return (
    <div className="relative hidden md:block w-full h-full bg-background bg-black">
